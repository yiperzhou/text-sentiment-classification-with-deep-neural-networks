...
class VDCNN(nn.Module):
    ...
    def __init__(self, n_classes, vocabulary_size, depth, embed_size, optional_shortcut, k):
        ...
        optional_shortcut = optional_shortcut # True
        k = k # 8
...
if __name__ == '__main__':
    ...
    model = VDCNN(depth=29, vocabulary_size=29, embed_size=16, n_classes=2, k=2, optional_shortcut=True)
