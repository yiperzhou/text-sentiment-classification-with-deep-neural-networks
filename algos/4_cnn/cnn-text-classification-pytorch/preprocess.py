...
def prepare_data_and_model(using_gpu=True):
    # tut thinkstation
    train_path = "/home/yi/sentimentAnalysis/data/text_classification_data/tripadvisor_train_dataset.csv"
    test_path = "/home/yi/sentimentAnalysis/data/text_classification_data/tripadvisor_test_dataset.csv"
    ...
    # tut thinkstation
    # glove_file_path = '/home/yi/sentimentAnalysis/data/word_embedding_data/glove/glove.6B.50d.txt'
