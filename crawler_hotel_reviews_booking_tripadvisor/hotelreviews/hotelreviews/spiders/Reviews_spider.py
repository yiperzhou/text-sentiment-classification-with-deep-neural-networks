...
class ReviewsSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        "https://www.tripadvisor.com/Hotel_Review-g189934-d228670-Reviews-Scandic_Grand_Marina-Helsinki_Uusimaa.html"
    ]
    def __init__(self):
        self.reviewPage = 1
        # for line in open("/home/yi/Music/hotel-reviews-sbooking-tripadvisor/hotelreviews/Tampere_tripadvisor_list.txt", "r").readlines():
