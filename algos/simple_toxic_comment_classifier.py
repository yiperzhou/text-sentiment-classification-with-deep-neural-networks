...
train = pd.read_csv('/home/yi/sentimentAnalysis/algos/5_ToxicCommentClassification-pytorch/data/train.csv')
test = pd.read_csv('/home/yi/sentimentAnalysis/algos/5_ToxicCommentClassification-pytorch/data/test.csv')
...
y_pred = pd.read_csv('/home/yi/sentimentAnalysis/algos/5_ToxicCommentClassification-pytorch/data/sample_submission.csv')
